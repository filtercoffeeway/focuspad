#!/usr/bin/env python3
"""
Docker-specific data statistics script for FocusPad API.
...
def print_data_statistics():
    ...
    print("=" * 50)
    print("📊 FOCUSPAD DATA STATISTICS (Docker)")
    print("=" * 50)
...
def main():
    ...
    # Force Docker configuration for inside container
    config_name = 'docker'
    
    print(f"🔧 Using environment: {config_name}")
    print("🐳 Running inside Docker container")
    
    # Set Docker database URL
